...
symp1 = input("Symptom_1 : ")
symp2 = input("Symptom_2 : ")
symp3 = input("Symptom_3 : ")
symp4 = input("Symptom_4 : ")
symp5 = input("Symptom_5 : ")
...
new_inpt_dict ={v: k for k, v in input_dict.items()}

symp1 = new_inpt_dict.get((input("Symptom_1 : ")))
symp2 = new_inpt_dict.get((input("Symptom_2 : ")))
symp3 = new_inpt_dict.get((input("Symptom_3 : ")))
symp4 = new_inpt_dict.get((input("Symptom_4 : ")))
symp5 = new_inpt_dict.get((input("Symptom_5 : ")))
